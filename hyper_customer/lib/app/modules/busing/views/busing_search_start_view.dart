...
class BusingSearchStartView extends GetView<BusingSearchRouteController> {
  const BusingSearchStartView({Key? key}) : super(key: key);
  @override
        ...
        child: Scaffold(
          body: Column(
            children: [
              ...
              Obx(
                () {
                  if (controller.startSearchItems.value.isEmpty &&
                      controller.startSearchEditingController.text.isEmpty) {
                    return Text(
                  ...
                  return Column(
                    children: controller.startSearchItems.value,
                  );
                },
              )
            ],
                ...
                Container(
                  ...
                  child: GetBuilder<SearchTextFieldController>(
                    init: SearchTextFieldController(
                        controller.startSearchEditingController),
                    builder: (textFieldController) {
                      return TextFormField(
                        controller: controller.startSearchEditingController,
                        onFieldSubmitted: controller.startOnSearchChanged,
                        onChanged: controller.startOnSearchChanged,
